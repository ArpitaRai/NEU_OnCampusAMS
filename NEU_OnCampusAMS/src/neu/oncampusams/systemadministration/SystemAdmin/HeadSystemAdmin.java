 ...
 */
public class HeadSystemAdmin extends javax.swing.JFrame {

    String emailID;
    /**
     * Creates new form Warden1
     */
    public HeadSystemAdmin() {
        initComponents();
    }

    public HeadSystemAdmin(String eid) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 30, 380, 30));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 300, 80, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HeadSystemAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HeadSystemAdmin().setVisible(true);
            }
        });
    }
